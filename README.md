...
**npm is configured to use npm, Inc.'s package registry at
...
Use of someone else's registry may be governed by terms of use. The terms
of use for the default registry are available at <https://www.npmjs.com>.
